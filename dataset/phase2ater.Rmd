...
#### try 3 diff
based on 3 method that we tasted earlier we determine to try k=2, k=3, k=4 !!!!!
...
# Compute and plot wss for k = 1 to k = 11
k.values <- 1:11

# extract wss for 2-11 clusters
wss_values <- dataset(k.values, wss)
