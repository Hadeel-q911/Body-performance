...
+------------+------------+------------+------------+
| name       | d          | data type  | p ossible  |
|            | escription |            | value      |
+============+============+============+============+
| Age        | The        | numerical  | 21-64      |
|            | person's   |            |            |
|            | age in     |            |            |
|            | years      |            |            |
+------------+------------+------------+------------+
| Gender     | The        | binary     | F,M        |
|            | person's   |            |            |
|            | gender     |            |            |
+------------+------------+------------+------------+
| Height_cm  | The        | numerical  | 125-194    |
|            | person's   |            |            |
|            | Height in  |            |            |
|            | cm         |            |            |
+------------+------------+------------+------------+
| we ight_kg | The        | numerical  | 2 6.3-138  |
|            | person's   |            |            |
|            | weight in  |            |            |
|            | Kg         |            |            |
+------------+------------+------------+------------+
| body       | the amount | numerical  | 3 %-78.4%  |
| fat\_%     | of         |            |            |
|            | essential  |            |            |
|            | fat .      |            |            |
+------------+------------+------------+------------+
| diastolic  | measures   | numerical  | 0-156      |
|            | pressure   |            |            |
|            | the blood  |            |            |
|            | vessels    |            |            |
|            | when the   |            |            |
...
|            | at rest    |            |            |
+------------+------------+------------+------------+
| systolic   | measures   | numerical  | 0-201      |
|            | pressure   |            |            |
|            | in the     |            |            |
|            | arteries   |            |            |
|            | when the   |            |            |
...
|            | minutes    |            |            |
+------------+------------+------------+------------+
| gripForce  | fingers    | numerical  | 0-70.5     |
|            | f          |            |            |
|            | lexibility |            |            |
|            | tests      |            |            |
+------------+------------+------------+------------+
| sit and    | measures   | numerical  | -25-213    |
| bend for   | f          |            |            |
| ward_cm    | lexibility |            |            |
|            | in sitting |            |            |
|            | and        |            |            |
...
|            | ntimeters. |            |            |
+------------+------------+------------+------------+
| sit-ups    | measures   | numerical  | 0-80       |
| counts_cm  | the        |            |            |
|            | strength   |            |            |
|            | and        |            |            |
|            | endurance  |            |            |
...
### ^[[3]](https://rpubs.com/camguild/803096)^5.1 Classification:
...
### ^[[4]](https://rpubs.com/odenipinedo/cluster-analysis-in-R)^5.2 Clustering:
...
| width for    |         | ,       | ,       |
| each cluter  | clute   | clute   | clute   |
|              | r2=0.67 | r2=0.60 | r2=0.30 |
|              |         | ,       | ,       |
|              |         | clute   | clute   |
|              |         | r3=0.41 | r3=0.37 |
|              |         |         | ,clute  |
...
+--------------+---------+---------+---------+
| Total        | 5       | 3       | 2       |
| within-      | 91064.6 | 10351.6 | 30049.1 |
| cluster sum  |         |         |         |
| of square    |         |         |         |
+--------------+---------+---------+---------+
| BCubed       | 0       | 0       | 0       |
| Precison     | .       | .       | .       |
|              | 2516112 | 2516393 | 2522583 |
+--------------+---------+---------+---------+
| BCubed       | 0       | 0       | 0       |
| Recall       | .       | .387276 | .       |
|              | 5454527 |         | 2729353 |
...
## ^[[5]](https://www.kaggle.com/code/shivanirana63/guide-to-complete-statistical-analysis)^7. Finding:
...
[3].[Classification and Regression Trees (CART) in
R](https://rpubs.com/camguild/803096)

[4]. [Cluster Analysis in
R](https://rpubs.com/odenipinedo/cluster-analysis-in-R)

[5].[guide to complete statistical
analysis](https://www.kaggle.com/code/shivanirana63/guide-to-complete-statistical-analysis)
