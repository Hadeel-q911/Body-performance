...
|          | in minutes                     |          |          |
+----------+--------------------------------+----------+----------+
| gr       | fingers flexibility tests      | nu       | 0-70.5   |
| ipForce  |                                | merical  |          |
+----------+--------------------------------+----------+----------+
| sit and  | measures flexibility in        | nu       | -25-213  |
| bend for | sitting and bending forward in | merical  |          |
| ward_cm  | centimeters.                   |          |          |
+----------+--------------------------------+----------+----------+
| sit-ups  | measures the strength and      | nu       | 0-80     |
| co       | endurance of the abdominals    | merical  |          |
| unts_cm  | and hip-flexor muscles in      |          |          |
|          | centimeter.                    |          |          |
+----------+--------------------------------+----------+----------+
| broad    | It is a method of measuring    | nu       | 0-303    |
| jump_cm  | how far a person can jump from | merical  |          |
|          | a standing position to a       |          |          |
|          | landing position.              |          |          |
+----------+--------------------------------+----------+----------+
| class    | body performance score         | nu       | A,B,C,D  |
|          |                                | merical  |          |
+----------+--------------------------------+----------+----------+
...
| Clusters     |              |              |              |
+:============:+:============:+:============:+:============:+
| Average      | c            | cluter1=0.58 | cluter1=0.55 |
| Silhouette   | luter1=0.56, | ,            | ,            |
| width for    |              | cluter2=0.60 | cluter2=0.30 |
| each cluter  | cluter2=0.67 | ,            | ,            |
|              |              | cluter3=0.41 | cluter3=0.37 |
|              |              |              | ,            |
|              |              |              | cluter4=0.46 |
+--------------+--------------+--------------+--------------+
...
| isualization | figures is   | figures is   | figures is   |
|              | shown above  | shown above  | shown above  |
+--------------+--------------+--------------+--------------+
