...
### 3.1: Data Source : ^[[1]](https://www.kaggle.com/datasets/kukuroo3/body-performance-data)^
...
### 4.2 Understanding the dataset using graph representations:^[[2]](https://www.kaggle.com/code/codeguyas101/body-performance-data-eda),[[2]](https://www.kaggle.com/code/shivanirana63/guide-to-complete-statistical-analysis)^
...
### 5.1 Classification:^[[3]](https://rpubs.com/camguild/803096)^
...
### 5.2 Clustering:^[[4]](https://rpubs.com/odenipinedo/cluster-analysis-in-R)^
...
## 7. Finding:^[[5]](https://www.kaggle.com/code/shivanirana63/guide-to-complete-statistical-analysis)^
