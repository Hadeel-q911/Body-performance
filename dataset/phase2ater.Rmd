...
+-------------+-------------+-------------+-------------+
| name        | description | data type   | p ossible   |
|             |             |             | value       |
+=============+=============+=============+=============+
| Age         | The         | nu merical  | 21-64       |
|             | person's    |             |             |
|             | age in      |             |             |
|             | years       |             |             |
+-------------+-------------+-------------+-------------+
...
|             | gender      |             |             |
+-------------+-------------+-------------+-------------+
| He ight_cm  | The         | nu merical  | 125-194     |
|             | person's    |             |             |
|             | Height in   |             |             |
|             | cm          |             |             |
+-------------+-------------+-------------+-------------+
| we ight_kg  | The         | nu merical  | 2 6.3-138   |
|             | person's    |             |             |
|             | weight in   |             |             |
|             | Kg          |             |             |
+-------------+-------------+-------------+-------------+
| body fat\_% | the amount  | nu merical  | 3 %-78.4%   |
|             | of          |             |             |
|             | essential   |             |             |
|             | fat .       |             |             |
+-------------+-------------+-------------+-------------+
| di astolic  | measures    | nu merical  | 0-156       |
|             | pressure    |             |             |
|             | the blood   |             |             |
|             | vessels     |             |             |
|             | when the    |             |             |
...
|             | rest        |             |             |
+-------------+-------------+-------------+-------------+
| s ystolic   | measures    | nu merical  | 0-201       |
|             | pressure in |             |             |
|             | the         |             |             |
|             | arteries    |             |             |
|             | when the    |             |             |
...
|             | in minutes  |             |             |
+-------------+-------------+-------------+-------------+
| gr ipForce  | fingers     | nu merical  | 0-70.5      |
|             | flexibility |             |             |
|             | tests       |             |             |
+-------------+-------------+-------------+-------------+
| sit and     | measures    | nu merical  | -25-213     |
| bend for    | flexibility |             |             |
| ward_cm     | in sitting  |             |             |
|             | and bending |             |             |
|             | forward in  |             |             |
|             | c           |             |             |
|             | entimeters. |             |             |
+-------------+-------------+-------------+-------------+
| sit-ups co  | measures    | nu merical  | 0-80        |
| unts_cm     | the         |             |             |
|             | strength    |             |             |
|             | and         |             |             |
|             | endurance   |             |             |
...
|             | centimeter. |             |             |
+-------------+-------------+-------------+-------------+
| broad       | It is a     | nu merical  | 0-303       |
| jump_cm     | method of   |             |             |
|             | measuring   |             |             |
|             | how far a   |             |             |
|             | person can  |             |             |
...
| Clusters | (best)   |          |          |
+:========:+:========:+:========:+:========:+
| Average  | c l u t  | c l u    | c l u    |
| S        | e        | t        | t        |
| i        | r1=0.56, | er1=0.58 | er1=0.55 |
| lhouette |          | , c l u  | , c l u  |
| width    | c l u    | t        | t        |
| for each | t        | er2=0.60 | er2=0.30 |
| cluter   | er2=0.67 | , c l u  | , c l u  |
|          |          | t        | t        |
|          |          | er3=0.41 | er3=0.37 |
|          |          |          | , c l u  |
|          |          |          | t        |
...
| width    |          |          |          |
+----------+----------+----------+----------+
| Total w  | 591064.6 | 310351.6 | 230049.1 |
| i t h i  |          |          |          |
| n        |          |          |          |
| -cluster |          |          |          |
| sum of   |          |          |          |
...
+----------+----------+----------+----------+
| BCubed   | 0        | 0        | 0        |
| Precison | .2516112 | .2516393 | .2522583 |
+----------+----------+----------+----------+
| BCubed   | 0        | 0.387276 | 0        |
| Recall   | .5454527 |          | .2729353 |
+----------+----------+----------+----------+
| V i s u  | all of   | all of   | all of   |
| a        | the      | the      | the      |
| lization | figures  | figures  | figures  |
|          | is shown | is shown | is shown |
|          | above    | above    | above    |
+----------+----------+----------+----------+
