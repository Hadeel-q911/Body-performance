...
#Outlire_height_cm
```{r}
Outheight_cm = outlier(dataset$height_cm, logical =TRUE)
sum(Outheight_cm)
Find_outlier = which(Outheight_cm ==TRUE, arr.ind = TRUE)
Outheight_cm
Find_outlier
#dataset= dataset[-Find_outlier,]
```
```{r}
Outweight_kg = outlier(dataset$weight_kg, logical =TRUE)
sum(Outweight_kg)
Find_outlier = which(Outweight_kg ==TRUE, arr.ind = TRUE)
Outweight_kg
Find_outlier
#dataset= dataset[-Find_outlier,]
```
```{r}
Outbody.fat_. = outlier(dataset$body.fat_., logical =TRUE)
sum(Outbody.fat_.)
Find_outlier = which(Outbody.fat_. ==TRUE, arr.ind = TRUE)
Outbody.fat_.
Find_outlier
#dataset= dataset[-Find_outlier,]
```
```{r}
Outdiastolic = outlier(dataset$diastolic, logical =TRUE)
sum(Outdiastolic)
Find_outlier = which(Outdiastolic ==TRUE, arr.ind = TRUE)
Outdiastolic
Find_outlier
#dataset= dataset[-Find_outlier,]
```
```{r}
Outsystolic = outlier(dataset$systolic, logical =TRUE)
sum(Outsystolic)
Find_outlier = which(Outsystolic ==TRUE, arr.ind = TRUE)
Outsystolic
Find_outlier
#dataset= dataset[-Find_outlier,]
```
```{r}
OutgripForce = outlier(dataset$gripForce, logical =TRUE)
sum(OutgripForce)
Find_outlier = which(OutgripForce ==TRUE, arr.ind = TRUE)
OutgripForce
Find_outlier
#dataset= dataset[-Find_outlier,]
```
